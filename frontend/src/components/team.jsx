        ...
        <section className="py-5" aria-labelledby="teamHeading">
            <div className="container">
                <div className="text-center mb-4">
                    ...
                    <div aria-hidden="true" className="mx-auto" style={{
                        width: 120,
                        height: 12,
                        background: "radial-gradient(60px 6px at 60px 6px, rgba(2,6,23,.25), rgba(2,6,23,.12) 60%, rgba(0,0,0,0) 61%)"
                    }} />
                </div>
                    ...
                    {members.map((m, idx) => (
                        <div className="col-12 col-sm-6 col-lg-3 text-center" key={idx}>
                            <div className="mx-auto mb-3" style={{
                                ...
                                boxShadow: "0 10px 25px rgba(2,6,23,.1)",
                                background: "#f3f4f6"
                            }}>
